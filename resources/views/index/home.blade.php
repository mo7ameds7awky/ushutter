...
<div class="wrapper">
{{-- <div class="container"> --}}
	<div class="row margin-bottom-40" style="overflow-x: hidden;">
				<div class="col-md-12 btn-block margin-bottom-40">
	    	...
	    	@foreach(  $categories->chunk(4) as $column )
				...
				@foreach ($column as $category)
					<li>
						<div class="category_thumbnail">
							<img src="@if($category->thumbnail == null) {{asset('public/img-category/default.jpg')}} @else {{asset('public/img-category/' . $category->thumbnail)}} @endif" alt="">
